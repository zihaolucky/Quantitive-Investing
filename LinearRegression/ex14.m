function ex14(symbol,ma1,ma2,ma3,percent)
%% Instruction
...
x = data((0.9-percent)*end+1:0.9*end+5,1);

X_test = data(0.9*end+1:0.9*end+5,1:5);
...
y_test = data(0.9*end+1:0.9*end+5, 6);

[X_test(:,1),x(end-4:end),y_test];
...
theta = zeros(6, 1);
[theta, J_history] = gradientDescentMulti14(X, y, theta, alpha, num_iters);
...
% part #2
predict_y2=X_test*theta;
[predict_y2,y_test,(predict_y2-y_test)./y_test]
