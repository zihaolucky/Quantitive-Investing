function predict_y2=ex13(symbol,ma1,ma2,ma3,percent,add)
%% Instruction
...
X = data((0.9-percent)*end+1:0.9*end+add,1:2);
x = data((0.9-percent)*end+1:0.9*end+add+1,1);

X_test = data(0.9*end:end, 1:2);
...
theta = zeros(3, 1);
[theta, J_history] = gradientDescentMulti13(X, y, theta, alpha, num_iters);
